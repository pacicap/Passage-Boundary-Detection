...
# Hyperparameters
LEARNING_RATE = 2e-5  # 1.2e-5, 1.5e-5, 2e-5, 3e-5, 5e-5
BATCH_SIZE = 16  # 8, 16, 32
WARMUP_STEPS = 500  # 0, 100, 500, 1000, 10000
NUM_EPOCHS = 5  # 2, 3, 5, 10
...
# Load dataset
data_file = "/content/shared_data/dataset2_pair_sentences_final.jsonl"
...
plot_confusion_matrix(test_true_labels,
                      test_predictions,
                      class_names,
                      "paper_b_2_dl_bert_model_confusion_matrix_final_Hp14.png",
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("/content/images/paper_b_1_dl_bert_model_losses_final_Hp14.png")
plt.close()
